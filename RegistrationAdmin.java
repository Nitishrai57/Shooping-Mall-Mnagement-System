...
public class RegistrationAdmin {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistrationAdmin window = new RegistrationAdmin();
	...
	private void initialize() {
		...
		lblRegistrationForm.setBounds(211, 22, 368, 29);
		...
		lblddmmyyyy.setFont(new Font("Dialog", Font.BOLD, 16));
		lblddmmyyyy.setBounds(386, 149, 125, 16);
		...
		btnRegister.setBounds(311, 497, 200, 43);
		...
		btnBack.setBounds(68, 508, 117, 32);
		frame.getContentPane().add(btnBack);
		 img = new ImageIcon(this.getClass().getResource("/employee.png")).getImage();
    ...
    public void registerUserData() {
    	...
    	st1.execute("INSERT INTO AdminInfo (Name,Gender,Password,DOB,Mobile_Number,Email,Address,State,Username) VALUES('"+name+"','"+gender+"','"+password+"','"+dobb+"','"+mobileNumber+"','"+email+"','"+area+"','"+state+"','"+username+"')");
