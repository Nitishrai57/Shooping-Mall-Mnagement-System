...
public class InventoryCustomer {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InventoryCustomer window = new InventoryCustomer(vishal);
	...
	public InventoryCustomer(String a) {
		vishal = a;
		initialize();
	...
	private void initialize() {
		...
		btnDisplay.setBounds(580, 166, 132, 25);
		...
		btnBack.setBounds(58, 932, 117, 36);
